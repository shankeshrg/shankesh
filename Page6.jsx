                ...
                <Grid style={{  height:'110vh',marginTop:'0px',backgroundSize:'absolute',backgroundColor:'rgba(159, 174, 167, 1)'
                    ...
                    <div>
                        ...
                        <Card  style={{marginLeft:'300px',width:'1275px',marginTop:'250px',borderRadius:"50px",top:'249px',height:'539px',backgroundColor:'rgba(217, 217, 217, 1)'}}>
                               <img src="./Ponnu.jpg" alt="" style={{borderRadius:'50px',marginLeft:'50px',marginTop:'50px',width:'286px',height:'440px'}}/>
                             <Card style={{width:'683px',height:'403px',marginTop:'-425px',marginLeft:'470px',backgroundColor:'rgba(184,194,221,1)',borderRadius:'50px'}}>
                                <Typography style={{fontSize:'24px',marginLeft:'50px',marginTop:'50px'}}>Name:Helen Lawrence</Typography><br />
                                <Typography style={{fontSize:'24px',marginLeft:'50px',}}>Age:25</Typography><br />
                                <Typography style={{fontSize:'24px',marginLeft:'50px',}}>Occupation:Doctor</Typography><br />
                                <Typography style={{fontSize:'24px',marginLeft:'50px'}}>Income:80k</Typography><br />
                                <Typography style={{fontSize:'24px',marginLeft:'50px'}}>Country:India</Typography><br />
                                <Typography style={{fontSize:'24px',marginLeft:'50px'}}>PH no:+9190809*****</Typography>
